...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (42538830,3000518)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (42538830,3000518)
  and c.invalid_reason is null
...
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (3010813,3000905)
  and c.invalid_reason is null
...
WHERE (C.value_as_number / NULLIF(C.range_low, 0)) < 1.0000
